...
def load_file_sn(parent = None, file_path = "./", folder_path = "./result/dist/xlsx/"):
    try:
        ...
        file_name = df_list[0][0][0]
        school_name = df_list[0][0][1]
        class_num = df_list[0][0][2]
        ...
        for page_df_list in df_list:
            ...
            # content_sub_title_list는 content칸의 성적 타이틀 정보를 포함한 list
            # content_text_list는 content칸의 학생별 정보를 포함한 list
            content_top_title_list, content_sub_title_list, content_text_list = convert.conv_content_sn(page_df_list[1])
            ...
            # # 시트의 content에 해당하는 부분 작성
            edit.edit_content_sn(wb, class_num, content_top_title_list, content_sub_title_list, content_text_list)
